...
#
describe AMQ::Client::Async::EventMachineClient, "Connection.Start" do
  ...
  context "with valid credentials" do
    it "should trigger the callback" do
      em do
        AMQ::Client::Async::EventMachineClient.connect do |client|
          done
        end
      end
    end
  ...
  context "with invalid credentials" do
    context "when given an errback" do
      it "should trigger the errback" do
        em do
          AMQ::Client::Async::EventMachineClient.connect(:port => 12938, :on_tcp_connection_failure => proc { done }) do |client|
    ...
    context "when given no errback" do
      it "should raise an error" do
        expect {
          em do
            AMQ::Client::Async::EventMachineClient.connect(:port => 12938) { }
            done(0.5)
          end
